...
/**
 * Environment bindings for the ClawWorker
 */
export interface MoltbotEnv {
  Sandbox: DurableObjectNamespace<Sandbox>;
  ASSETS: Fetcher; // Assets binding for admin UI static files
  R2_BUCKET: R2Bucket; // R2 bucket for persistent storage
  ...
  GATEWAY_TOKEN?: string; // Gateway token (preferred)
  MOLTBOT_GATEWAY_TOKEN?: string; // Legacy - use GATEWAY_TOKEN
  ...
  R2_BUCKET_NAME?: string; // Override bucket name (default: 'clawworker-data')
